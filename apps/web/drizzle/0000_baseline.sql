...
CREATE TABLE "data_sources" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "data_sources_provider_check" CHECK ("data_sources"."provider" = ANY (ARRAY['cube'::text, 'dbt'::text]))
);
--> statement-breakpoint
...
CREATE TABLE "organization" (
	...
	"createdAt" timestamp with time zone NOT NULL,
	"metadata" text,
	"runtimeApiKeyHash" text,
	"runtimeApiKeyPrefix" text,
...
CREATE INDEX "dashboards_organization_id" ON "dashboards" USING btree ("organization_id");--> statement-breakpoint
CREATE UNIQUE INDEX "data_sources_one_active" ON "data_sources" USING btree ("is_active") WHERE is_active;--> statement-breakpoint
